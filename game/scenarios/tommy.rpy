label tommy:
    ...
    $ set_focus("tommy", "normal", "lee", "normal")
    t "Hmm? Ah, well..."
    t "Haven't had the appetite with the funeral and everything, you know?"
